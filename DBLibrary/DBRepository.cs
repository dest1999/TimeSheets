...
namespace DBLibrary
{
    public class DBRepository : IDBRepository
    {
        ...
        public IEnumerable<Person> Read(int skip, int take)
        {
        ...
        {
            var tmp = Read(entity.Id);
            tmp.FirstName = entity.FirstName;
            tmp.LastName = entity.LastName;
            tmp.Email = entity.Email;
            tmp.Company = entity.Company;
            tmp.Age = entity.Age;
        }
    }
}
